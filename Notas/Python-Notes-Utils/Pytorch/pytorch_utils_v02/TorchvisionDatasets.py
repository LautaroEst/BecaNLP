...
from .myTorchvision import transforms as T
...
def GetCIFAR10Dataset(transform, val_size=.02, batch_size=64):
...
def GetMNISTDataset(transform, val_size=.02, batch_size=64):
    
    # Se descarga el dataset y se definen los dataloaders de train / validation / test:
    mnist_train = dset.CIFAR10('Datasets/TorchvisionDatasets/CIFAR10/train', train=True, download=True,
                                 transform=transform)
    
    mnist_val = dset.CIFAR10('Datasets/TorchvisionDatasets/CIFAR10/train', train=True, download=True,
                               transform=transform)

    mnist_test = dset.CIFAR10('Datasets/TorchvisionDatasets/CIFAR10/test/', train=False, download=True, 
                                transform=transform)
